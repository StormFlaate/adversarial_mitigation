...
def main(year, model_name):
    ...
    pca_1_list = np.array([[tensor.mean().item() for tensor in sublist] for sublist in pca_1_list])
    pca_2_list = np.array([[tensor.mean().item() for tensor in sublist] for sublist in pca_2_list])
