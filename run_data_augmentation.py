...
from config import (AUGMENTED_TRAIN_2018_LABELS, AUGMENTED_TRAIN_2018_ROOT_DIR, 
                    MIN_NUMBER_OF_EACH_CLASS, RANDOM_HORIZONTAL_FLIP_PROBABILITY, 
                    RANDOM_VERTICAL_FLIP_PROBABILITY, RANDOM_ROTATION_PROBABILITY, 
                    TRAIN_2018_LABELS, TRAIN_2018_ROOT_DIR, RANDOM_AFFINE_PROBABILITY)
